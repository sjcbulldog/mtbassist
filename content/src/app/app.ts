...
import { InstallChoiceComponent } from "./install-choice/install-choice";

@Component({
  selector: 'app-root',
  imports: [MtbNav, SoftwareInstallerComponent, IdcLauncherRequiredComponent, InstallChoiceComponent],
