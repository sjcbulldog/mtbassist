...
export class CMakeBuildSupport extends EventEmitter {
    ...
    public constructor(env: ModusToolboxEnvironment, logger: winston.Logger) {
        ...
        this.env_ = env ;
        this.logger_ = logger;
        this.toolchainFile_ = 'toolchain.cmake' ;
    ...
    private writeTopLevelCMakeListsFile() : void {
        ...
        contents.push(`cmake_minimum_required(VERSION 4.2)`) ;
        contents.push('') ;
    ...
    private getCFlags(config: CMakeOneConfig) : string[] {
        const cflags = this.filterCompileFlags(config.flags_.get('cflags') || '') ;
